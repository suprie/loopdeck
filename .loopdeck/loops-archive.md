...
### 2026-07-19 — Phase 3a — Crash-safe critical state + recoverable registry (Gate A items 3-4)
...
## Archived from loops.md — 2026-08-30 (memory-hygiene compaction)

<!-- Full-fidelity copy of origin/main's active loops.md from '## History'
     down (post-#92 state). An earlier variant of this appendix derived from
     the c81ab69 lineage was superseded by this union rebuild; that lineage's
     unique Current/Next Steps text is preserved in git history (c81ab69). -->
