...
import { Repeat, Loader2, AlertTriangle, Play, CheckCircle2, Circle, ChevronDown, ArrowRight } from "lucide-react";
      ...
      <div className="h-14 shrink-0 px-6 border-b border-border flex items-center justify-between bg-background/80 backdrop-blur sticky top-0 z-10">
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Current loops and next steps across all projects
          </p>
        </div>
      </div>
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0 flex-1">
                        ...
                        {!isExpanded && ls.next_steps.length > 0 && (
                          <p className="text-[11px] text-muted-foreground mt-1">
                            {ls.next_steps.length} pending next step
                            {ls.next_steps.length !== 1 ? "s" : ""}
                          </p>
                        )}
                      </div>
                      ...
                      {/* Chevron */}
                      <ChevronDown
                        className={`size-3.5 text-muted-foreground shrink-0 mt-0.5 transition-transform ${
                          ...
                          <div>
                            ...
                            <ul className="mt-1.5 space-y-1">
                              {ls.history.slice(0, 5).map((h, i) => (
                                ...
                                >
                                  <CheckCircle2 className="size-3 shrink-0 mt-0.5 text-[var(--success)]/60" />
